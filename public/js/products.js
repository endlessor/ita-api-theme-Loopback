...
function renderProducts(p) {
  ...
  bind('.product-edit', function () {
    ...
    bind('.mainContainer .addProductContainer .pop-up .p-row.save', function () {
      ...
      obj.nickname = $('.mainContainer .addProductContainer .pop-up .p-row.nname').val().split(',').map(function (el) {
        return el.trim()
      });

      _s = obj.categories.find(function (el) {
        return el.name == $('.mainContainer .addProductContainer .pop-up .p-row.c').val();
      });
  ...
  bind('.product-add', function () {
    ...
    bind('.mainContainer .addProductContainer .pop-up .p-row.save', function () {
      ...
      _s = data.categories.find(function (el) {
        return el.name == $('.mainContainer .addProductContainer .pop-up .p-row.c').val();
      });
